...
To accomplish this, each plugin is assigned a unique `app_id`, which is a SHA2 hash ensuring distinctiveness and recognizability of each plugin's tables. For instance, the default Contacts plugin in 2WAY might be associated with the `app_id` `d2a6c37f9c6c441b8b3e8a5d8a3d2f4a`, resulting in table names like `d2a6c37f9c6c441b8b3e8a5d8a3d2f4a_attributes`, `d2a6c37f9c6c441b8b3e8a5d8a3d2f4a_parents`, and so forth.
